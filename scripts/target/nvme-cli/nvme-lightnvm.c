...
int lnvm_do_init(char *dev, char *mmtype)
{
	...
	strncpy_no_trunc_warning(init.dev, dev, DISK_NAME_LEN);
	strncpy_no_trunc_warning(init.mmtype, mmtype, NVM_MMTYPE_LEN);
					...
					int over_prov, int flags)
{
	...
	strncpy_no_trunc_warning(c.dev, devname, DISK_NAME_LEN);
	strncpy_no_trunc_warning(c.tgtname, tgtname, DISK_NAME_LEN);
	strncpy_no_trunc_warning(c.tgttype, tgttype, NVM_TTYPE_NAME_MAX);
	c.flags = flags;
						...
						int clear_bb_marks)
{
	...
	strncpy_no_trunc_warning(fact.dev, devname, DISK_NAME_LEN);
