...
#define __blk_to_disk_sect_shift(d) (NVMEIBC_SECTOR_SHIFT - (d)->sector_shift)		// Translation beetween volume block size and NVME disk formatted block size. Daniel: Todo, make this per volume
