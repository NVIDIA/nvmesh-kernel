...
extern void TEST_set_kafka_last_transient_err_boot_sec(int64_t sec);
extern void TEST_check_if_kafka_init_preserve_state_vars_required(rd_kafka_resp_err_t err);
