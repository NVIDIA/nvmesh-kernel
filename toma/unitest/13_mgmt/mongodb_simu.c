...
void sb_cluster_conf_create( struct sb_cluster_conf *sb) {
	...
	{	// Create 2 volumes:		All uuids are generated as 32bits integers 0xbd0V0CRS, where V is volume index, C,R,S are chunk, raid and seg indices respectively. Counting starts from 1.
...
int sb_cluster_get_node_idx_from_disk_uuid(  uint32_t u) { return DISK_UUID_GET_IDX_MASK(u) >> 20; }
int sb_cluster_get_disk_idx_from_disk_uuid_n(uint32_t u) { return u&0xf; }
