...
//	BOOL								is_leader_conf_reserialization_required;	TODO(Replace with gap between leader_calculated and leader_to_commit);
	...
	struct nvmeib_hash_table			*local_nics_hash_by_sw_gid_str;
	//
	...
	XDLIST_DECLARE(, struct nvmeibt_registrant_ctx, longing_on_invalid_seg_link) longing_on_invalid_seg_list_by_handle;		// When client receives configuration before Toma and wants to register on unknown disk segment
