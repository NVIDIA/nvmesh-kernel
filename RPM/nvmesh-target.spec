...
mv -n %{buildroot}/opt/nvmesh/target-repo/target_*/tools/toma_rpc/toma_rpc %{buildroot}/opt/nvmesh/common-repo/tools/
mv -n %{buildroot}/opt/nvmesh/target-repo/target_*/tools/toma_rpc/toma_link %{buildroot}/opt/nvmesh/common-repo/tools/
