...
- [Architecture Decisions (resolved)](#architecture-decisions-resolved)
- [Part 1 — Management Layer](#part-1--management-layer)
  - [1.1 MongoDB Schema — Volume Model Extensions](#11-mongodb-schema--volume-model-extensions)
  - [1.2 REST API — New and Modified Endpoints](#12-rest-api--new-and-modified-endpoints)
  - [1.3 Kafka/MCS Message Changes](#13-kafkamcs-message-changes)
  - [1.4 Module Changes](#14-module-changes)
  - [1.5 UI Changes](#15-ui-changes)
- [Part 1.5 — Allocator Satellite Volume (`<CDV>-mgmt`)](#part-15--allocator-satellite-volume-cdv-mgmt)
  - [1.5.1 Problem Statement — Why a Satellite Volume](#151-problem-statement--why-a-satellite-volume)
  - [1.5.2 How NVMesh Actually Enforces Exclusivity — Preemption](#152-how-nvmesh-actually-enforces-exclusivity--preemption)
  - [1.5.3 Options Considered](#153-options-considered)
  - [1.5.4 Implementation Spec](#154-implementation-spec)
  - [1.5.5 What This Supersedes](#155-what-this-supersedes)
- [Part 2 — TOMA: CDV.allocator](#part-2--toma-cdvallocator)
  - [2.1 Overview](#21-overview)
  - [2.2 On-Disk Format (Allocator Area)](#22-on-disk-format-allocator-area)
  - [2.3 In-Memory State](#23-in-memory-state)
  - [2.4 Cold Recovery (TOMA restart)](#24-cold-recovery-toma-restart)
  - [2.5 CDV Topology: Allocator Identity](#25-cdv-topology-allocator-identity)
  - [2.6 Allocator Election and Identity Propagation](#26-allocator-election-and-identity-propagation)
  - [2.7 Allocation Transactionality and Split-Brain Protection](#27-allocation-transactionality-and-split-brain-protection)
  - [2.8 CDV\_extent Allocation Protocol (ADMIN Channel)](#28-cdv_extent-allocation-protocol-admin-channel)
  - [2.9 Recovery Changes to Existing TOMA Code](#29-recovery-changes-to-existing-toma-code)
  - [2.10 Per-Client CDV Preemption](#210-per-client-cdv-preemption)
  - [2.11 NVCK Support](#211-nvck-support)
- [Part 3 — Kernel Client: TPV Datapath](#part-3--kernel-client-tpv-datapath)
  - [3.1 New Kernel Subdirectory: `clnt/tpv/`](#31-new-kernel-subdirectory-clnttpv)
  - [3.2 New Volume Class Handling](#32-new-volume-class-handling)
  - [3.3 Core Data Structures](#33-core-data-structures)
  - [3.4 Allocator State Persistence Format (per-TPV L1/L2 Tree)](#34-allocator-state-persistence-format-per-tpv-l1l2-tree)
  - [3.5 IO Path](#35-io-path)
  - [3.6 TPV\_extent Alloc / Free](#36-tpv_extent-alloc--free)
  - [3.7 CDV\_extent Request from Client](#37-cdv_extent-request-from-client)
  - [3.8 Attach / Detach](#38-attach--detach)
  - [3.9 TPV.Delete](#39-tpvdelete)
  - [3.10 TPV Grow](#310-tpv-grow)
- [Part 4 — Testing](#part-4--testing)
  - [Shipped kernel self-tests (`clnt/tpv/nvmeibc_tpv_test.c`)](#shipped-kernel-self-tests-clnttpvnvmeibc_tpv_testc)
  - [Planned / not-yet-shipped tests](#planned--not-yet-shipped-tests)
- [Part 5 — CDV Auto-Attachment to TOMA Nodes](#part-5--cdv-auto-attachment-to-toma-nodes)
  - [5.1 Rationale](#51-rationale)
  - [5.2 Attachment Reference Tracking](#52-attachment-reference-tracking)
  - [5.3 Determining the TOMA Node Set](#53-determining-the-toma-node-set)
  - [5.4 Module: `modules/cdvTomaAutoAttach.js`](#54-module-modulescdvtomautoattachjs)
  - [5.5 `toma:` Reference Lifecycle](#55-toma-reference-lifecycle)
  - [5.6 `tpv:` Reference Lifecycle](#56-tpv-reference-lifecycle)
  - [5.7 CDV Deletion](#57-cdv-deletion)
  - [5.8 Edge Cases](#58-edge-cases)
- [Part 6 — Observability: proc Files](#part-6--observability-proc-files)
  - [6.1 Client-Side: TPV Allocator State](#61-client-side-tpv-allocator-state)
  - [6.2 TOMA-Side: CDV Allocator State](#62-toma-side-cdv-allocator-state)
  - [6.3 Python Analysis Scripts](#63-python-analysis-scripts)
- [Part 7 — Simulator Updates](#part-7--simulator-updates)
  - [7.1 TOMA Simulator (`toma/nvmeibt_toma_simu.h/.c`)](#71-toma-simulator-tomannvmeibt_toma_simuhc)
  - [7.2 Management Simulator (`mgmt/nvmeibm_mgmt_simu.h/.c`)](#72-management-simulator-mgmtnvmeibm_mgmt_simuhc)
  - [7.3 Client Simulator](#73-client-simulator)
  - [7.4 RAM Disk Simulator](#74-ram-disk-simulator)
  - [7.5 New Simulator Test Scenarios](#75-new-simulator-test-scenarios)
- [Part 8 — UI Implementation Detail](#part-8--ui-implementation-detail)
  - [8.1 consts.js](#81-constsjs)
  - [8.2 Express Route — Thin Provisioning Page](#82-express-route--thin-provisioning-page)
  - [8.3 Router Registration](#83-router-registration)
  - [8.4 Sidebar — New "Thin Provisioning" Section](#84-sidebar--new-thin-provisioning-section)
  - [8.5 Regular Volumes Table — CDV Filter Checkboxes](#85-regular-volumes-table--cdv-filter-checkboxes)
  - [8.6 Create/Edit Volume Dialog — CDV Toggle](#86-createedit-volume-dialog--cdv-toggle)
  - [8.7 TPV Table Page](#87-tpv-table-page)
  - [8.8 TPV Create/Edit Modal](#88-tpv-createedit-modal)
  - [8.9 VolumesService Additions](#89-volumesservice-additions)
  - [8.10 Route Handlers in volumes.js](#810-route-handlers-in-volumesjs)
  - [8.11 Attach Dialog — TPV Informational Note](#811-attach-dialog--tpv-informational-note)
- [Part 9 — File Checklist](#part-9--file-checklist)
  - [New files](#new-files)
  - [Modified files](#modified-files)
- [Part 5 — TPV Encryption](#part-5--tpv-encryption)
  - [5.1 Overview](#51-overview)
  - [5.2 How Regular Volume Encryption Works (reference)](#52-how-regular-volume-encryption-works-reference)
  - [5.3 TPV Encryption — Architecture Decisions](#53-tpv-encryption--architecture-decisions)
  - [5.4 TPV Encryption Flow](#54-tpv-encryption-flow)
  - [5.5 ~~CDV Extent Pre-allocation for Encrypted TPVs~~ (removed)](#55-cdv-extent-pre-allocation-for-encrypted-tpvs-removed)
  - [5.6 TOMA Selection for TPV Encryption](#56-toma-selection-for-tpv-encryption)
  - [5.7 Kafka Message Changes](#57-kafka-message-changes)
  - [5.8 TOMA Changes (`nvmeibt_kafka.c`, `nvmeibt_recovery.c`)](#58-toma-changes-nvmeibt_kafkac-nvmeibt_recoveryc)
  - [5.9 Management Module Changes](#59-management-module-changes)
  - [5.10 UI Changes](#510-ui-changes)
  - [5.11 Encryption Column in TPV Table](#511-encryption-column-in-tpv-table)
  - [5.12 CLI Changes (`nvmesh-infra/xlro/tools/cli`)](#512-cli-changes-nvmesh-infraxlrotoolscli)
  - [5.13 CSI Driver Changes (`nvmesh-csi-driver`)](#513-csi-driver-changes-nvmesh-csi-driver)
  - [5.14 Implementation Steps](#514-implementation-steps)
  - [5.15 Risks and Open Questions](#515-risks-and-open-questions)
- [Part 10 — CDV and TPV Allocation Statistics in Management UI](#part-10--cdv-and-tpv-allocation-statistics-in-management-ui)
  - [10.1 Overview](#101-overview)
  - [10.2 Architecture Decisions](#102-architecture-decisions)
  - [10.3 Data Model — MongoDB Extensions](#103-data-model--mongodb-extensions)
  - [10.4 CDV Stats: TOMA to Management](#104-cdv-stats-toma-to-management)
  - [10.5 TPV Stats: Client to Management](#105-tpv-stats-client-to-management)
  - [10.6 "Max Additional Extents" Computation](#106-max-additional-extents-computation)
  - [10.7 UI Changes](#107-ui-changes)
  - [10.8 Implementation Steps](#108-implementation-steps)
- [Part 11 — TPV Hot Upgrade (NDU)](#part-11--tpv-hot-upgrade-ndu)
  - [11.1 Problem Statement](#111-problem-statement)
  - [11.2 Design Overview](#112-design-overview)
  - [11.3 Struct Changes](#113-struct-changes)
  - [11.4 Registration Through ATOM](#114-registration-through-atom)
  - [11.5 Abandon Sequence (Old nvmeibc Going Down)](#115-abandon-sequence-old-nvmeibc-going-down)
  - [11.6 Adopt Sequence (New nvmeibc Coming Up)](#116-adopt-sequence-new-nvmeibc-coming-up)
  - [11.7 In-Flight IO Draining](#117-in-flight-io-draining)
  - [11.8 CDV Ordering During NDU](#118-cdv-ordering-during-ndu)
  - [11.9 Pending BIO Lifecycle Across NDU](#119-pending-bio-lifecycle-across-ndu)
  - [11.10 `nvmeibc_tpv_submit_bio_wrapper` and Module Text Safety](#1110-nvmeibc_tpv_submit_bio_wrapper-and-module-text-safety)
  - [11.11 ATOM Discovery — Distinguishing TPV Atoms from Regular Atoms](#1111-atom-discovery--distinguishing-tpv-atoms-from-regular-atoms)
  - [11.12 Implementation Checklist](#1112-implementation-checklist)
  - [11.13 Edge Cases and Failure Modes](#1113-edge-cases-and-failure-modes)
  - [11.14 Testing](#1114-testing)
- [Part 12 — Graceful IO Rejection and Pending-Bio Timeout](#part-12--graceful-io-rejection-and-pending-bio-timeout)
  - [12.1 Problem Statement](#121-problem-statement)
  - [12.2 Design](#122-design)
  - [12.3 Struct Changes](#123-struct-changes)
  - [12.4 IO Path Changes](#124-io-path-changes)
  - [12.5 Detach Path](#125-detach-path)
  - [12.6 Modified Files](#126-modified-files)
- [13. NVMesh-CLI CDV/TPV Support](#13-nvmesh-cli-cdvtpv-support)
  - [13.1 Overview](#131-overview)
  - [13.2 SDK Layer (`volume.py`)](#132-sdk-layer-volumepy)
  - [13.3 Entity Metadata (`rest.yaml`)](#133-entity-metadata-restyaml)
  - [13.4 `rest_click.py` — Extend `waitable`](#134-rest_clickpy--extend-waitable)
  - [13.5 Custom CLI Behavior (`rest_custom.py`)](#135-custom-cli-behavior-rest_custompy)
  - [13.6 `current.api` Additions](#136-currentapi-additions)
  - [13.7 `current.display` Additions](#137-currentdisplay-additions)
  - [13.8 Known Pitfalls](#138-known-pitfalls)
- [Part 14 — CSI Driver TPV Orchestration](#part-14--csi-driver-tpv-orchestration)
  - [14.1 Overview](#141-overview)
  - [14.2 StorageClass Parameters](#142-storageclass-parameters)
  - [14.3 Management API — No Server-Side Enhancement Needed for MVP](#143-management-api--no-server-side-enhancement-needed-for-mvp)
  - [14.4 CSI Driver File Changes](#144-csi-driver-file-changes)
  - [14.5 Controller RPC Changes (detail)](#145-controller-rpc-changes-detail)
  - [14.6 Node RPC Changes](#146-node-rpc-changes)
  - [14.7 Capacity Warnings Surfaced to Kubernetes — *planned*](#147-capacity-warnings-surfaced-to-kubernetes--planned)
  - [14.8 Immutability and ModifyVolume — *deferred*](#148-immutability-and-modifyvolume--deferred)
  - [14.9 Known Pitfalls](#149-known-pitfalls)
- [Section 15 — Post-MVP Features](#section-15--post-mvp-features)
...
- **Extend.** Volume-extend on a CDV extends **only** the CDV. The satellite size is fixed at creation (to the admin-supplied `cdvConfig.allocatorSizeGib`, default 1 GiB). Each GiB of satellite supports ~8.4M extent records (32 × 128-byte records per 4 KiB block — see §2.2). At the default 1 GiB the CDV can carry up to ~8.4M × its extent size; admins provisioning a very large CDV with a small extent raise allocatorSizeGib at create time. Keeping the satellite size fixed after create preserves the Mongo update path single-document.
...
The natural shape would be one record per atomic write unit — but the atomic unit on an NVMesh volume is the whole bio, not the 4 KiB block. An earlier draft of this design reserved 4 KiB per record (on the rationale that the allocator area lived on the raw CDV block device, where 4 KiB was the smallest atomic unit). That draft never shipped; the as-built satellite volume carries packed 128-byte records from the start. The 84-byte useful payload fits comfortably with 44 bytes of headroom, and the density wins are:

- **Satellite headroom.** A 1 GiB default satellite addresses ~8.4M extents. At the unpacked alternative that would have been 262 k.
- **Scan/I-O locality.** Sequential allocations share a block. A small LRU of in-flight satellite blocks in TOMA amortises the RMW cost.
- **Cost: RMW per update.** A single-record mutation becomes `read(4 KiB) → overwrite 128 B → write(4 KiB)` under the per-CDV `handler_lock`. Satellite I/O is off the data hot path and the extra 4 KiB read caches well, so the cost is negligible in practice.

128 bytes was chosen for natural power-of-2 alignment and 44 bytes of headroom above the 84-byte payload — room for future per-extent fields (timestamps, per-TPV name hash, additional flags) without a version bump. `CDV_ONDISK_VERSION` is retained at 1 (the packed layout is the only version shipped); a future incompatible format change would bump it and gate compatibility via the scan's version check.
...
#define CDV_ONDISK_VERSION          1             /* packed 128-B records */
...
The `maxAddressableExtents` is computed from the allocator area geometry: one 4 KiB header block + 32 × 128-byte records per subsequent 4 KiB block (§2.2) = `((allocatorSizeGib × 1 GiB − 4 KiB) / 128)`. At the default `allocatorSizeGib = 1` this is ~8 388 576.
