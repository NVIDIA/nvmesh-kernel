...
- [1. Problem statement](#1-problem-statement)
  - [1.1 What "shared" must mean](#11-what-shared-must-mean)
  - [1.2 The tree-corruption hazard -- the load-bearing problem](#12-the-tree-corruption-hazard----the-load-bearing-problem)
  - [1.3 Non-goals](#13-non-goals)
- [2. Design space](#2-design-space)
  - [2.1 Option A -- Client-side replicated tree with distributed locking](#21-option-a----client-side-replicated-tree-with-distributed-locking)
  - [2.2 Option B -- TOMA-authoritative mapping (recommended)](#22-option-b----toma-authoritative-mapping-recommended)
  - [2.3 Option C -- Mapping-Owner-Client (MOC) lease](#23-option-c----mapping-owner-client-moc-lease)
  - [2.4 Recommendation](#24-recommendation)
- [3. Architectural overview (Option C)](#3-architectural-overview-option-c)
  - [3.1 Owner lifecycle](#31-owner-lifecycle)
  - [3.2 The new RPC surface](#32-the-new-rpc-surface)
  - [3.3 Degradation to exclusive](#33-degradation-to-exclusive)
  - [3.4 `<TPV>-meta` satellite -- the tree-write fencing mechanism](#34-tpv-meta-satellite----the-tree-write-fencing-mechanism)
- [4. Management layer changes](#4-management-layer-changes)
  - [4.1 Schema](#41-schema)
  - [4.2 TPV create -- satellite co-allocation](#42-tpv-create----satellite-co-allocation)
  - [4.3 `attachTPV` changes](#43-attachtpv-changes)
  - [4.4 `detachTPV` changes](#44-detachtpv-changes)
  - [4.5 `updateTPV` / `deleteTPVs` / `extendTPV`](#45-updatetpv--deletetpvs--extendtpv)
  - [4.6 Encryption interaction](#46-encryption-interaction)
  - [4.7 Per-client CDV preemption interaction](#47-per-client-cdv-preemption-interaction)
- [5. Client kernel changes](#5-client-kernel-changes)
  - [5.1 Role in `struct nvmeibc_tpv`](#51-role-in-struct-nvmeibc_tpv)
  - [5.2 IO path](#52-io-path)
  - [5.3 Allocator state on an MF](#53-allocator-state-on-an-mf)
  - [5.4 Work items](#54-work-items)
  - [5.5 Invalidations on MFs](#55-invalidations-on-mfs)
  - [5.6 MO failover on the kernel side](#56-mo-failover-on-the-kernel-side)
  - [5.7 IO during handoff](#57-io-during-handoff)
- [6. TOMA changes](#6-toma-changes)
- [7. Testing strategy](#7-testing-strategy)
- [8. Risks and open questions](#8-risks-and-open-questions)
  - [8.1 Interaction with per-CDV preempt (`TPV_PerClientCDVPreemption.md`)](#81-interaction-with-per-cdv-preempt-tpv_perclientcdvpreemptionmd)
  - [8.2 Interaction with TPV encryption (`TPV_EncryptionPlan.md`)](#82-interaction-with-tpv-encryption-tpv_encryptionplanmd)
  - [8.3 MO RPC load scaling](#83-mo-rpc-load-scaling)
  - [8.4 Handoff snapshot size](#84-handoff-snapshot-size)
  - [8.5 Downgrade path](#85-downgrade-path)
  - [8.6 L1/L2 tree fencing -- the core correctness argument](#86-l1l2-tree-fencing----the-core-correctness-argument)
  - [8.7 Test requirements specifically targeting tree corruption](#87-test-requirements-specifically-targeting-tree-corruption)
  - [8.8 Observability](#88-observability)
  - [8.9 Not yet answered](#89-not-yet-answered)
