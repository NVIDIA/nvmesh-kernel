...
#define NVMESH_DATA_PARTITION_TYPE_GUID_JOURNALED_CONST	{.ll = {0xFB2D6A17E4084CC9, 0x95A347C7506E54E5}}
#define NVMESH_DATA_PARTITION_TYPE_GUID_NO_JOURNAL_CONST	{.ll = {0x1510F276AB164C60, 0xB3C4847E6F1EA937}}
#define NVMESH_DATA_PARTITION_TYPE_GUID_DATA_OLD_CONST	{.ll = {0x1234567898765432, 0x1234567898765432}}
#define NVMESH_DATA_PARTITION_TYPE_GUID_DEL_JOURNAL_CONST {.ll = {0x8F6FD59661F44E6B, 0xB4A6809ED84EA2B9}}
#define NVMESH_METADATA_PARTITION_TYPE_GUID_CONST			{.ll = {0x1C6BD8FA3CA24AA3, 0xA66427C4AB070B9D}}
#define NVMESH_METADATA_UPGRADE_PARTITION_TYPE_GUID_CONST	{.ll = {0x51BF5B8DBC584C56, 0xA8849B75CC96275B}}
#define NVMESH_METADATA_PARTITION_TYPE_GUID_OLD_CONST		{.ll = {0x9876543212345678, 0x9876543212345678}}
#define NVMESH_JOURNAL_DATA_PARTITION_TYPE_GUID_CONST 	{.ll = {0x7A0F8886426A4B11, 0x90FEFD1441D8CE3B}}
#define NVMESH_SERJIO_DB_PARTITION_TYPE_GUID_CONST 		{.ll = {0xFC553B0944E54508, 0xAE79D05163FFD494}}
#define NVMESH_JOURNAL_DATA_PARTITION_TYPE_GUID_OLD_CONST	{.ll = {0x13579BDF98765432, 0x13579BDF98765432}}
#define NVMESH_SERJIO_DB_PARTITION_TYPE_GUID_OLD_CONST 	{.ll = {0x1234432156789876, 0x1234432156789876}}

#define NVMESH_DATA_PARTITION_TYPE_GUID_JOURNALED		((const union nvmeib_uuid)NVMESH_DATA_PARTITION_TYPE_GUID_JOURNALED_CONST)  /*Used to fill partition type of segment partitions in GPT, */
#define NVMESH_DATA_PARTITION_TYPE_GUID_NO_JOURNAL	((const union nvmeib_uuid)NVMESH_DATA_PARTITION_TYPE_GUID_NO_JOURNAL_CONST)  /*Used to fill partition type of segment partitions in GPT, */
#define NVMESH_DATA_PARTITION_TYPE_GUID_DATA_OLD		((const union nvmeib_uuid)NVMESH_DATA_PARTITION_TYPE_GUID_DATA_OLD_CONST)  /*Used to fill partition type of old segment partitions in GPT, */
#define NVMESH_METADATA_PARTITION_TYPE_GUID			((const union nvmeib_uuid)NVMESH_METADATA_PARTITION_TYPE_GUID_CONST)
#define NVMESH_METADATA_UPGRADE_PARTITION_TYPE_GUID	((const union nvmeib_uuid))NVMESH_METADATA_UPGRADE_PARTITION_TYPE_GUID_CONST)
#define NVMESH_METADATA_PARTITION_TYPE_GUID_OLD		((const union nvmeib_uuid)NVMESH_METADATA_PARTITION_TYPE_GUID_OLD_CONST)
#define NVMESH_JOURNAL_DATA_PARTITION_TYPE_GUID 		((const union nvmeib_uuid)NVMESH_JOURNAL_DATA_PARTITION_TYPE_GUID_CONST)
#define NVMESH_SERJIO_DB_PARTITION_TYPE_GUID 			((const union nvmeib_uuid)NVMESH_SERJIO_DB_PARTITION_TYPE_GUID_CONST)
#define NVMESH_DISK_METADATA_PARTITION_TYPE_GUID 		((const union nvmeib_uuid){.ll = {0x02468ACECA864202, 0x02468ACECA864202}})	// Resides in our internal GPT (in the metadata partition)
#define NVMESH_SEGMENT_METADATA_PARTITION_TYPE_GUID 	((const union nvmeib_uuid){.ll = {0x8877665544332211, 0x2233445566778899}})	// Resides in our internal GPT (in the metadata partition)
#define NVMESH_DISK_UUID_1_2_UNKNOWN_AWAIT_MGMT		((const union nvmeib_uuid){.ll = {0x49840866709b6e56, 0x926c2733f0449587}})	// 709b6e56-0866-4984-8795-44f033276c92
...
{
	return (ARE_UUID_EQ(partition_type_guid, &NVMESH_DATA_PARTITION_TYPE_GUID_JOURNALED) ||
			ARE_UUID_EQ(partition_type_guid, &NVMESH_DATA_PARTITION_TYPE_GUID_NO_JOURNAL) ||
			ARE_UUID_EQ(partition_type_guid, &NVMESH_DATA_PARTITION_TYPE_GUID_DATA_OLD));
}
...
enum {
	...
	NVMEIB_DISK_MAX_NVMEXPRESS_ID_SIZE = 40,		// like: S3HCNX0K501681.1 (NVMesh concatenates ID with name space so the string is longer
	NVMEIB_DISK_MAX_MODEL_STR_SIZE = 40,			// like: SAMSUNG MZWLL800HEHP-00003, note: may include spaces and such
	NVMEIB_HOST_NAME_LEN = 64,						// like: nvme111.acme.com
...
struct nvmeibs_toma_serjio_request_jgc_msg {
	char disk_id[NVMEIB_DISK_MAX_NVMEXPRESS_ID_SIZE];
	char seg_id[URN_UUID_STR_LENGTH + 1];
	u16 vendor_id;
};
...
enum uk_comm_opcode {
	...
	/* 2.3 */
	csc_local_client,
	csc_local_clnt_msg_to_toma,
	csc_toma_msg_to_local_clnt,
	csc_msg_to_process,
...
#define VDISK_MODEL "NVMESH_VDISK"
