...
| Decoder/tooling | PET has dedicated extractor/viewer (`nvmeib_pet_messages.py`) with a direct archive parser | Binary trace ecosystem is integrated with trace channels/events and existing tracing pipeline |
