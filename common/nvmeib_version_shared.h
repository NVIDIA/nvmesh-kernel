...
/* Body lives in nvmeib_version_kernel.c so that COMMIT_ID (used by the
 * _NT trace expansion inside) does not force every TU transitively
 * including this header to rebuild on a commit-id bump. */
