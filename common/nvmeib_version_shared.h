...
/*
 * Generated by the top-level Makefile (cmp-swap).  Provides COMMIT_ID,
 * BRANCH_NAME, NVMESH_VERSION, NVMESH_RELEASE, BUILD_DISTRO, BUILD_NUMBER.
 * Needed here because the inline below references COMMIT_ID at parse time.
 */
