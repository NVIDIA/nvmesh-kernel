...
#if	defined(KERNEL_SUSE11SP3)

#	define KS_KBASENAME						0
#	define KS_DMA_DIRECTION					0
#	define KS_REINIT_COMPLETION				0
#	define KS_LIST_LAST_ENTRY				0
#	define KS_LIST_FIRST_ENTRY_OR_NULL		0
#	define KS_HASHTABLE 					0
#	define KS_RBTREE 						0
#	define KS_PCI_MSIX_VEC_COUNT 			0
#	define KS_DEV_MSIX_CAP					0
#	define KS_BIO_VEC_RET_STRUCT			0
#	define KS_BI_REMAINING					0
#	define KS_BLOCK_DEV_MAKE_REQUEST_VOID	0
#	define KS_BLOCK_DEV_DEVICE_CLOSE_VOID	0
#	define KS_DMA_SET_MASK_AND_COHERENT		0
#	define KS_NVME_SC_CMD_SEQ_ERROR			0
#	define KS_BVEC_ITER						0
#	define KS_IB_SRQ_TYPE					0
#	define KS_WAIT_EVENT_LOCK				0
#	define KS_PDE_DATA						0
#	define KS_LIST_PREV_NEXT				0
#	define KS_HASHTABLE					1
#	define KS_VM_FLAGS_T					vm_flags_t
#	define KS_MLX5						1
#	define KS_MODULE_PARAM_CB				0
#	define KS_KALLSYMS_LOOKUP				1
#	define KS_ENDIO_1ARG					0
#	define KS_RDMA_WR						0
#	define KS_USE_RDTSC						0

#elif defined(KERNEL_ORACLE)
...
#endif
#ifndef KS_BIO_COPY_DATA_ITER
#	define KS_BIO_COPY_DATA_ITER			K_CHECK_VER(4,18,0)
#endif
...
#	define KS_KALLSYMS_LOOKUP 	(K_CHECK_VER(2,6,33) && !K_CHECK_VER(5,7,0))
#endif
...
#	define	KS_BIO_HAS_BI_DISK_PTR			K_CHECK_VER(4,14,0) && !K_CHECK_VER(5,12,0)
#endif
#ifndef KS_BIO_BI_STATUS
#	define KS_BIO_BI_STATUS			K_CHECK_VER(4,12,14)
#endif
#ifndef KS_BIO_INIT_WITH_BVEC
#       define KS_BIO_INIT_WITH_BVEC                 K_CHECK_VER(4,10,0)
#endif
...
#endif
#ifndef KS_HAS_PART_INC_DEC_IN_FLIGHT
#	define KS_HAS_PART_INC_DEC_IN_FLIGHT KERNEL_VERSION_LT(5,8,0)
#endif
...
#endif
#ifndef KS_HAS_GUID_PARSE
#define KS_HAS_GUID_PARSE		K_CHECK_VER(4,13,0)
#endif
...
#endif
#ifndef KS_HAS_PROC_FS
#define KS_HAS_PROC_FS K_CHECK_VER(5,6,0)
#endif
#ifndef KS_HAS_MMAP_SEM_LOC
#      define KS_HAS_MMAP_SEM_LOC K_CHECK_VER(5,8,0)
#endif
#ifndef KS_HAS_PART_STAT_H
#      define KS_HAS_PART_STAT_H KERNEL_VERSION_GE(5,8,0)
#endif
#ifndef KS_HAS_PART_STAT_CPU
#      define KS_HAS_PART_STAT_CPU KERNEL_VERSION_LT(5,0,0)
#endif
#ifndef KS_HAS_PART_STAT_LOCK_CPU
#      define KS_HAS_PART_STAT_LOCK_CPU KERNEL_VERSION_LT(5,8,0)
#endif
#ifndef KS_HAS_NEW_BLK_ALLOC_QUEUE
#      define KS_HAS_NEW_BLK_ALLOC_QUEUE KERNEL_VERSION_GE(5,8,0) && KERNEL_VERSION_LT(5,9,0)
#endif
...
#endif
#ifndef KS_HAS_RTC_TM_TO_TIME
#      define KS_HAS_RTC_TM_TO_TIME KERNEL_VERSION_LT(5,8,0)
#endif
#ifndef KS_HAS_DEVLINK_H
#	define KS_HAS_DEVLINK_H KERNEL_VERSION_GE(4,6,0)
#endif
#ifndef KS_HAS_BIO_FREE_PAGES
#	define KS_HAS_BIO_FREE_PAGES K_CHECK_VER(4,0,0)
#endif

#ifndef KS_NO_TIMESPEC_STRUCT_FOR_KERNEL
#define KS_NO_TIMESPEC_STRUCT_FOR_KERNEL KERNEL_VERSION_GE(5,6,0)
#endif

#ifndef KS_SECTION_GET_STR_AS_PARAM
#define KS_SECTION_GET_STR_AS_PARAM KERNEL_VERSION_GE(5,10,0)
#endif

/* Commit: 6b57cea9221b0 added to Kernel 5.6, dispatches the GID_CHANGE events by the GID cache after the cache has been updated.
 * This fixes the race-condition between the cache being updated and NVMesh processing the GID_CHANGE event.*/
#ifndef KS_IB_CACHE_DOES_EVENT_DISPATCH
#define KS_IB_CACHE_DOES_EVENT_DISPATCH KERNEL_VERSION_GE(5,6,0)
#endif

#ifndef KS_HAS_BLKMODE
#define KS_HAS_BLKMODE KERNEL_VERSION_GE(6,5,0)
#endif

#ifndef KS_BLK_ALLOC_DISK_2PARAMS
#define KS_BLK_ALLOC_DISK_2PARAMS	KERNEL_VERSION_GE(6,9,0)
#endif
